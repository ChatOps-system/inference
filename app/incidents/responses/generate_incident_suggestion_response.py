...
class GenerateIncidentSuggestionResponse(BaseModel):
    ...
    model_config = {
        "json_schema_extra":{
            "example": {
                    ...
                    "message": "incident suggestion generated successfully for message Se produjo una caída de energía repentina en la planta principal. Varias máquinas se apagaron de inmediato y los paneles de control mostraron alertas intermitentes. El equipo de mantenimiento no ha identificado la causa."
